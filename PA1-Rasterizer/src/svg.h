...
struct Triangle : SVGElement {
  ...
  virtual Color color(float x0, float y0,float x1, float y1,float x2, float y2, float px, float py,
...
struct ColorTri : Triangle {
  ...
  Color color(float x0, float y0,float x1, float y1,float x2, float y2, float px, float py,
