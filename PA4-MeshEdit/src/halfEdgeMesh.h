   ...
   */
   ...
   class Halfedge : public HalfedgeElement
   {
      public:
         ...
         void setVertex(VertexIter vertex) {_vertex = vertex;}
         void setFace(FaceIter face) {_face = face;}
         void setNext(HalfedgeIter next) {_next = next;}
         void setTwin(HalfedgeIter twin) {_twin = twin;}
         void setEdge(EdgeIter edge) {_edge = edge;}
   ...
   class Face : public HalfedgeElement
   {
      public:
         ...
         void setHalfedge(HalfedgeIter halfedge){
           _halfedge = halfedge;
         }
